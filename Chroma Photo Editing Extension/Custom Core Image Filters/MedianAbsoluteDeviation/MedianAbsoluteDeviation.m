...
#import "MedianAbsoluteDeviation.h"
#import "GlobalCIImage.h"

@implementation MedianAbsoluteDeviation
...
- (CIKernel *)medianAbsoluteDeviationKernel
{
    static CIKernel *kernelMedianAbsoluteDeviation = nil;
    
    NSBundle    *bundle = [NSBundle bundleForClass:NSClassFromString(@"MedianAbsoluteDeviationKernel")];
    NSStringEncoding encoding = NSUTF8StringEncoding;
    NSError     *error = nil;
    NSString    *code = [NSString stringWithContentsOfFile:[bundle pathForResource:@"MedianAbsoluteDeviationKernel" ofType:@"cikernel"] encoding:encoding error:&error];
    
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        kernelMedianAbsoluteDeviation = [CIKernel kernelWithString:code];
    });
    
    return kernelMedianAbsoluteDeviation;
}
- (CIImage *)outputImage
{

...
#import "HybridMedian.h"
#import "GlobalCIImage.h"

@implementation HybridMedian
...
- (CIKernel *)hybridMedianKernel
{
    static CIKernel *kernelHybridMedian = nil;
    
    NSBundle    *bundle = [NSBundle bundleForClass:NSClassFromString(@"HybridMedian")];
    NSStringEncoding encoding = NSUTF8StringEncoding;
    NSError     *error = nil;
    NSString    *code = [NSString stringWithContentsOfFile:[bundle pathForResource:@"HybridMedianKernel" ofType:@"cikernel"] encoding:encoding error:&error];
    
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        kernelHybridMedian = [CIKernel kernelWithString:code];
    });
    
    return kernelHybridMedian;
}
- (CIImage *)outputImage
{
